...
(function() {
  var EventEmitter, KeyMirror, Line, Logger, NamedFunction, Nan, OS, Void, assertKind, childProcess, define, getKind, getType, inArray, isKind, isNodeEnv, isType, ref, repeatString, reportFailure, setKind, setType, stripAnsi, sync, testKind,
    slice = [].slice;
